...
public class MainActivity extends AppCompatActivity
    ...
    public void openHome(View v) {
        ...
        fragmentManager.beginTransaction().add(R.id.fragment_container, home, "home_page_fragment").commit();
...
//		}
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            FragmentManager fragmentManager = getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.fragment_container, home, null).addToBackStack(null).commit();
            ...
            FragmentManager fragmentManager = getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.fragment_container, threads, "Threads").addToBackStack(null).commit();
            ...
            FragmentManager fragmentManager = getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.fragment_container, forums, null).addToBackStack(null).commit();
            ...
            FragmentManager fragmentManager = getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.fragment_container, about, null).addToBackStack(null).commit();
        }
