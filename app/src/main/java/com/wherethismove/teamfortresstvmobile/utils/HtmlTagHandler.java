        ...
        implements Html.TagHandler
{
    ...
    private static Object getLast( Spanned text,
                                   Class kind )
    {
        /*
    ...
    private static void start( Editable text,
                               Object mark )
    {
        int len = text.length( );
    ...
    private static void end( Editable text,
                             Class kind,
                             Object repl )
    {
        int len = text.length( );
    ...
    private static void append( Editable text,
                                Class kind,
                                Object repl )
    {
        int len = text.length( );
